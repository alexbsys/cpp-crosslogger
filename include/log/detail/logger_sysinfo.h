...
/**
 * \brief    Get OS version information string (Windows). Query OS info from API
 * calls \param    os_version     Output string for OS version info \return true
 * - OS information obtained, false - error
 */
static bool get_os_version_display_string(std::string& os_version) {
  ...
  GetNativeSystemInfo_t get_native_system_info_fn =
      reinterpret_cast<GetNativeSystemInfo_t>(GetProcAddress(
  ...
  if (osvi.dwMajorVersion == 6) {
    ...
    if (get_product_info_fn) {
      get_product_info_fn(osvi.dwMajorVersion, osvi.dwMinorVersion, 0, 0,
                          &type);
    }

    switch (type) {
      case 0x0000 /*PRODUCT_UNDEFINED*/:
        os_version.append("(Product undefined)");
        break;
      case 0x0001 /*PRODUCT_ULTIMATE*/:
        os_version.append("Ultimate");
        break;
      case 0x0002 /*PRODUCT_HOME_BASIC*/:
        os_version.append("Home Basic");
        break;
      case 0x0003 /*PRODUCT_HOME_PREMIUM*/:
        os_version.append("Home Premium");
        break;
      case 0x0004 /*PRODUCT_ENTERPRISE*/:
        os_version.append("Enterprise");
        break;
      case 0x0005 /*PRODUCT_HOME_BASIC_N*/:
        os_version.append("Home Basic N");
        break;
      case 0x0006 /*PRODUCT_BUSINESS*/:
        os_version.append("Business");
        break;
      case 0x0007 /*PRODUCT_STANDARD_SERVER*/:
        os_version.append("Standard Server");
        break;
      case 0x0008 /*PRODUCT_DATACENTER_SERVER*/:
        os_version.append("Datacenter");
        break;
      case 0x0009 /*PRODUCT_SMALLBUSINESS_SERVER*/:
        os_version.append("Small Business Server");
        break;
      case 0x000A /*PRODUCT_ENTERPRISE_SERVER*/:
        os_version.append("Enterprise");
        break;
      case 0x000B /*PRODUCT_STARTER*/:
        os_version.append("Starter");
        break;
      case 0x000C /*PRODUCT_DATACENTER_SERVER_CORE*/:
        os_version.append("Datacenter Edition (core installation)");
        break;
      case 0x000D /*PRODUCT_STANDARD_SERVER_CORE*/:
        os_version.append("Standard Edition (core installation)");
        break;
      case 0x000E /*PRODUCT_ENTERPRISE_SERVER_CORE*/:
        os_version.append("Enterprise Edition (core installation)");
        break;
      case 0x000F /*PRODUCT_ENTERPRISE_SERVER_IA64*/:
        os_version.append("Enterprise Edition for Itanium-based Systems");
        break;
      case 0x0010 /*PRODUCT_BUSINESS_N*/:
        os_version.append("Business N");
        break;
      case 0x0011 /*PRODUCT_WEB_SERVER*/:
        os_version.append("Web Server");
        break;
      case 0x0012 /*PRODUCT_CLUSTER_SERVER*/:
        os_version.append("Cluster Server");
        break;
      case 0x0013 /*PRODUCT_HOME_SERVER*/:
        os_version.append("Home Server");
        break;
      case 0x0014 /*PRODUCT_STORAGE_EXPRESS_SERVER*/:
        os_version.append("Storage Express Server");
        break;
      case 0x0015 /*PRODUCT_STORAGE_STANDARD_SERVER*/:
        os_version.append("Storage Standard Server");
        break;
      case 0x0016 /*PRODUCT_STORAGE_WORKGROUP_SERVER*/:
        os_version.append("Storage Workgroup Server");
        break;
      case 0x0017 /*PRODUCT_STORAGE_ENTERPRISE_SERVER*/:
        os_version.append("Storage Enterprise Server");
        break;
      case 0x0018 /*PRODUCT_SERVER_FOR_SMALLBUSINESS*/:
        os_version.append("Server for Small Business");
        break;
      case 0x0019 /*PRODUCT_SMALLBUSINESS_SERVER_PREMIUM*/:
        os_version.append("Small Business Server Premium");
        break;
      case 0x001A /*PRODUCT_HOME_PREMIUM_N*/:
        os_version.append("Home Premium N");
        break;
      case 0x001B /*PRODUCT_ENTERPRISE_N*/:
        os_version.append("Enterprise N");
        break;
      case 0x001C /*PRODUCT_ULTIMATE_N*/:
        os_version.append("Ultimate N");
        break;
      case 0x001D /*PRODUCT_WEB_SERVER_CORE*/:
        os_version.append("Web Server (core installation)");
        break;
      case 0x0021 /*PRODUCT_SERVER_FOUNDATION*/:
        os_version.append("Server Foundation");
        break;
      case 0x0022 /*PRODUCT_HOME_PREMIUM_SERVER*/:
        os_version.append("Home Premium Server");
        break;
      case 0x0023 /*PRODUCT_SERVER_FOR_SMALLBUSINESS_V*/:
        os_version.append("Server for Small Business V");
        break;
      case 0x0024 /*PRODUCT_STANDARD_SERVER_V*/:
        os_version.append("Standard Server V");
        break;
      case 0x0025 /*PRODUCT_DATACENTER_SERVER_V*/:
        os_version.append("Datacenter V");
        break;
      case 0x0026 /*PRODUCT_ENTERPRISE_SERVER_V*/:
        os_version.append("Enterprise V");
        break;
      case 0x0027 /*PRODUCT_DATACENTER_SERVER_CORE_V*/:
        os_version.append("Datacenter V (core installation)");
        break;
      case 0x0028 /*PRODUCT_STANDARD_SERVER_CORE_V*/:
        os_version.append("Standard Server V (core installation)");
        break;
      case 0x0029 /*PRODUCT_ENTERPRISE_SERVER_CORE_V*/:
        os_version.append("Enterprise Server V (core installation)");
        break;
      case 0x002A /*PRODUCT_HYPERV*/:
        os_version.append("HyperV");
        break;
      case 0x002F /*PRODUCT_STARTER_N*/:
        os_version.append("Starter N");
        break;
      case 0x0030 /*PRODUCT_PROFESSIONAL*/:
        os_version.append("Professional");
        break;
      case 0x0031 /*PRODUCT_PROFESSIONAL_N*/:
        os_version.append("Professional N");
        break;
      case 0x0040 /*PRODUCT_CLUSTER_SERVER_V*/:
        os_version.append("Cluster Server V");
        break;
      case 0x0065 /*PRODUCT_CORE*/:
        os_version.append("Core");
        break;
      case 0x006D /*PRODUCT_CORE_SERVER*/:
        os_version.append("Core Server");
        break;
      case 0xABCDABCD /*PRODUCT_UNLICENSED*/:
        os_version.append("(Unlicensed)");
        break;
      default:
        os_version.append(str::stringformat("(Not decoded: %.4X)", type));
        break;
    }
  }
...
static bool get_os_version_display_string2(std::string& os_version) {
  ...
  log_registry_helper::get_reg_sz_value(
      HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion",
...
static bool get_host_name(std::string& name) {
  ...
  if (!::GetComputerNameExA(ComputerNamePhysicalDnsFullyQualified, buffer,
                            &size)) {
...
static std::string get_memory_status() {
  ...
  mem_info = str::stringformat(
      "Total physical " LOG_FMT_I64 ", Total virtual " LOG_FMT_I64,
...
static std::string get_current_user_sid() {
  ...
  if (token_handle == INVALID_HANDLE_VALUE) return std::string();
  ...
  do {
    ...
    if (ConvertSidToStringSidA(user_obj->User.Sid, &sid)) result = sid;
  } while (0);
...
static std::string get_memory_status() {
  ...
  memoryString =
      str::stringformat("Total avail RAM %" PRId64 ", total swap %" PRId64 ", total high %" PRId64,
                        static_cast<int64_t>(info.totalram), static_cast<int64_t>(info.totalswap), static_cast<int64_t>(info.totalhigh));
  memoryString += str::stringformat("\nFree RAM %d, free swap %d, free high %d",
                                    info.freeram, info.freeswap, info.freehigh);
  memoryString += str::stringformat("\nMem used by buffers %d, shared RAM %d",
                                    info.bufferram, info.sharedram);
  memoryString +=
...
static std::string query_os_type() {
#if defined(LOG_PLATFORM_WINDOWS)
  return "windows";
#elif defined(LOG_PLATFORM_ANDROID)
  return "android";
#elif defined(LOG_PLATFORM_IPHONE) || defined(LOG_PLATFORM_IPHONE_SIMULATOR)
  return "ios";
#elif defined(LOG_PLATFORM_MACOSX)
  return "mac";
#elif defined(LOG_PLATFORM_UNIX)
  return "unix";
#elif defined(LOG_PLATFORM_LINUX)
  return "linux";
#elif defined(LOG_PLATFORM_POSIX_BASED)
  return "posix";
#else
  return "unknown";
#endif
...
static std::string query_cpu_type() {
#if defined(LOG_CPU_INTEL) && defined(LOG_PLATFORM_64BIT) && defined(LOG_CPUARCH_IA32)
  return "amd64";
#elif defined(LOG_CPU_INTEL) && defined(LOG_PLATFORM_64BIT) && defined(LOG_CPUARCH_IA64)
  return "itanium64";
#elif defined(LOG_CPU_MIPS) && defined(LOG_PLATFORM_32BIT)
  return "mips32";
#elif defined(LOG_CPU_POWERPC) && defined(LOG_PLATFORM_32BIT)
  return "powerpc32";
#elif defined(LOG_CPU_POWERPC) && defined(LOG_PLATFORM_64BIT)
  return "powerpc64";
#elif defined(LOG_CPU_TMS320)
  return "tms320";
#elif defined(LOG_CPU_ARM) && defined(LOG_PLATFORM_32BIT)
  return "arm32";
#elif defined(LOG_CPU_ARM) && defined(LOG_PLATFORM_64BIT)
  return "arm64";
#elif defined(LOG_CPU_INTEL) && defined(LOG_CPUARCH_IA32) && defined(LOG_PLATFORM_32BIT)
  return "x86";
#else
  return "unknown";
#endif
...
static std::string query_system_info() {
  ...
  system_info << "Processor architecture: " << sys_info::get_processor_arch()
              << std::endl;
  if (sys_info_win::is_wow64_used()) system_info << "Used WOW64" << std::endl;

  system_info << str::stringformat("Current tick count: %d", GetTickCount())
              << std::endl;
  ...
  struct sysinfo info;
  sysinfo(&info);
  system_info << str::stringformat("Uptime, seconds: %d", info.uptime)
              << std::endl;
#endif  // LOG_HAVE_SYS_SYSINFO_H
  ...
  if (sys_info::get_host_name(host_name))
    system_info << "Host Name: " << host_name << std::endl;

  system_info << "Current user SID: " << sys_info::get_current_user_sid()
              << std::endl;
  system_info << "Current user name: " << sys_info::get_current_user_name()
              << std::endl;
  ...
  HMODULE module =
      reinterpret_cast<HMODULE>(pe_image::api_find_module_entry_point(
  ...
  if (module_definition::module_query_version_info(
          module, file_version, file_description, product_version, company_name,
          lang_id)) {
    if (file_version.size())
      system_info << "Module file version: " << file_version << std::endl;

    if (file_description.size())
      system_info << "Module file description: " << file_description
                  << std::endl;
    ...
    if (lang_id)
      system_info << "Module language ID: " << str::stringformat("%.X", lang_id)
                  << std::endl;
  }
